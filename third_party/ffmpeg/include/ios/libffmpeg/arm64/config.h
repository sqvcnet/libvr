...
#define FFMPEG_CONFIGURATION "--disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --enable-pthreads --enable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-encoders --enable-encoder=aac --enable-encoder=h264_videotoolbox --enable-encoder=mpeg4 --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=flv --enable-decoder=h264 --enable-decoder=hevc --enable-decoder='mp3*' --enable-decoder=vp6 --enable-decoder=vp6a --enable-decoder=vp6f --disable-hwaccels --enable-hwaccel=h264_videotoolbox --enable-hwaccel=h265_videotoolbox --disable-muxers --enable-muxer=mp4 --disable-demuxers --enable-demuxer=aac --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=loas --enable-demuxer=m4v --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegvideo --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-bsfs --disable-bsf=mjpeg2jpeg --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=text2movsub --enable-protocols --disable-protocol=bluray --disable-protocol=concat --disable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol=icecast --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol='rtmp*' --enable-protocol=rtmp --enable-protocol=rtmpt --disable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=unix --disable-devices --disable-iconv --enable-cross-compile --disable-stripping --arch=arm64 --target-os=darwin --enable-static --disable-shared --enable-pic --enable-neon --enable-optimizations --disable-debug --enable-small --prefix=/Users/shanqiang/ClionProjects/react-native-libvr-demo/node_modules/react-native-libvr/libvr/third_party/ffmpeg/src/ios/build/ffmpeg-arm64/output --cc='xcrun -sdk iphoneos clang' --extra-cflags=' -arch arm64 -miphoneos-version-min=8.0 -fembed-bitcode' --extra-cxxflags=' -arch arm64 -miphoneos-version-min=8.0 -fembed-bitcode' --extra-ldflags=' -arch arm64 -miphoneos-version-min=8.0 -fembed-bitcode '"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "/Users/shanqiang/ClionProjects/react-native-libvr-demo/node_modules/react-native-libvr/libvr/third_party/ffmpeg/src/ios/build/ffmpeg-arm64/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/shanqiang/ClionProjects/react-native-libvr-demo/node_modules/react-native-libvr/libvr/third_party/ffmpeg/src/ios/build/ffmpeg-arm64/output/share/ffmpeg"
...
#define CONFIG_H265_MEDIACODEC_DECODER 0
...
#define CONFIG_H265_MEDIACODEC_HWACCEL 0
...
#define CONFIG_H265_VIDEOTOOLBOX_HWACCEL 1
